...
-- Index để tìm kiếm token nhanh hơn khi filter
CREATE INDEX idx_token_value ON existing_tokens(token);

-- 2. PHÂN HỆ SẢN PHẨM & BIẾN THỂ
...
CREATE TABLE IF NOT EXISTS ProductSpecification (
    ...
    Width INT, Height INT, Depth INT, Weight INT,
